...
class HrLeave(models.Model):
    ...
    @api.constrains('employee_id', 'request_date_from', 'request_date_to', 'holiday_status_id.requests_limit')
    ...
    @api.constrains('request_date_from', 'request_date_to', 'holiday_status_id.request_offset')
